...
void Z80::z80_exec_extended_FDCB(struct zx80_memory* zx80_memory)
{
    unsigned char I; //register
    unsigned short J; //register

    J = this->registers.IY + this->OpZ80(zx80_memory, this->registers.PC);
...
void Z80::z80_exec_extended_FD(struct zx80_memory* zx80_memory)
{
  unsigned char I; //register
  unsigned short J; //register
...
//  #define XX IY
  ...
  switch(I)
  {
    ...
    case ADD_xHL:       this->debug_opcode((char *)"ADD_xIY+BYTE", (char *)"Adds the value pointed by (IY) plus BYTE to A");
        I = this->RdZ80(zx80_memory, this->registers.IY + this->OpZ80(zx80_memory, this->registers.PC));
        M_ADD(this, I); break;
    ...
    case INC_xHL:       this->debug_opcode((char *)"INC_xIY+BYTE", (char *)"Adds one to the memory location pointed to by IY plus BYTE.");
        I = this->RdZ80(zx80_memory, this->registers.IY + this->RdZ80(zx80_memory, this->registers.PC));
        M_INC_L(this, I);
        WrZ80(zx80_memory, this->registers.IY + this->OpZ80(zx80_memory, this->registers.PC), I);
        break;
    ...
    case POP_HL:       this->debug_opcode((char *)"POP_IY", (char *)"The memory location pointed to by SP is stored into IYl and SP is incremented. The memory location pointed to by SP is stored into IYh and SP is incremented again"); 
        M_POP(this, zx80_memory, IY);break;

    case EX_xSP_HL:      this->debug_opcode((char *)"EX_xSP_IY", (char*)"Exchanges (SP) with IYl, and (SP+1) with IYh");
        J = this->registers.IY;
        SET_WORD(this->registers.IY, this->RdZ80(zx80_memory, this->registers.SP), 
    ...
    case PUSH_HL:       this->debug_opcode((char *)"PUSH_IY", (char *)"SP is decremented and IYh is stored into the memory location pointed to by SP. SP is decremented again and IYl is stored pointed to by SP"); 
        M_PUSH(this, zx80_memory,IY);break;

                    
      case LD_HL_WORD:    this->debug_opcode_reg_word(zx80_memory, (char *)"LD_IY_WORD", (char *)"Loads ** into IY"); 
        M_LDWORD(this, zx80_memory, this->registers.IY);break;
      case LD_xWORD_HL:    this->debug_opcode_reg_word(zx80_memory, (char *)"LD_xWORD_IY", (char *)"Stores IY into the memory location pointed to by WORD");
        M_LDWORD(this, zx80_memory, J); 
        WrZ80(zx80_memory, J, LSB(this->registers.IY));
        J += 1;
        WrZ80(zx80_memory, J, MSB(this->registers.IY));
        break;
      case LD_H_BYTE:     this->debug_opcode_reg_byte(zx80_memory, (char *)"LD_IYh_BYTE", (char *)"Load BYTE into IYh");
          SET_MSB(this->registers.IY, this->OpZ80(zx80_memory, this->registers.PC));
          break;
      case LD_HL_xWORD:    this->debug_opcode_reg_word(zx80_memory, (char *)"LD_IY_xWORD", (char *)"Load value pointed to by WORD into IY");
        M_LDWORD(this, zx80_memory, J); 
        SET_LSB(this->registers.IY, this->RdZ80(zx80_memory, J));
        J += 1;
        SET_MSB(this->registers.IY, this->RdZ80(zx80_memory, J));
        break;
      case LD_L_BYTE:     this->debug_opcode_reg_byte(zx80_memory, (char *)"LD_IYl_BYTE", (char *)"Load BYTE into IYl");
          SET_LSB(this->registers.IY, this->OpZ80(zx80_memory, this->registers.PC));
          break;

      case LD_xHL_BYTE:   this->debug_opcode_reg_byte_byte(zx80_memory, (char *)"LD_xIYl_BYTE", (char *)"Stores BYTE to the memory location pointed to by IY plus BYTE");
          J = this->registers.IY + this->OpZ80(zx80_memory, this->registers.PC);
      ...
      case LD_B_xHL:      this->debug_opcode((char *)"LD_B_xIY", (char *)"The contents of IY plus BYTE are loaded into B");
          SET_MSB(this->registers.BC, this->RdZ80(zx80_memory, this->registers.IY + this->OpZ80(zx80_memory, this->registers.PC)));
          break;
      ...
      case LD_C_xHL:      this->debug_opcode((char *)"LD_C_xIY", (char *)"The contents of IY plus BYTE are loaded into C");
          SET_LSB(this->registers.BC, this->RdZ80(zx80_memory, this->registers.IY + this->OpZ80(zx80_memory, this->registers.PC)));
          break;
      ...
      case LD_D_xHL:      this->debug_opcode((char *)"LD_D_xIY", (char *)"The contents of IY plus BYTE are loaded into D");
          SET_MSB(this->registers.DE, this->RdZ80(zx80_memory, this->registers.IY + this->OpZ80(zx80_memory, this->registers.PC)));
          break;
      ...
      case LD_E_xHL:      this->debug_opcode((char *)"LD_E_xIY", (char *)"The contents of IY plus BYTE are loaded into E");
          SET_LSB(this->registers.DE, this->RdZ80(zx80_memory, this->registers.IY + this->OpZ80(zx80_memory, this->registers.PC)));
          break;
      ...
      case LD_H_xHL:      this->debug_opcode((char *)"LD_H_IYL", (char *)"Loads the value pointed to IY plus BYTE into H");
          SET_MSB(this->registers.HL, this->RdZ80(zx80_memory, this->registers.IY + this->OpZ80(zx80_memory, this->registers.PC)));
          break;
      ...
      case LD_L_xHL:        this->debug_opcode((char *)"LD_L_xIY", (char *)"Loads the value pointed to IY plus BYTE into L");
          SET_LSB(this->registers.HL, this->RdZ80(zx80_memory, this->registers.IY + this->OpZ80(zx80_memory, this->registers.PC)));
          break;
      ...
      case LD_A_xHL:        this->debug_opcode((char *)"LD_L_xIY", (char *)"Loads the value pointed to IY plus BYTE into A");
          SET_MSB(this->registers.AF, this->RdZ80(zx80_memory, this->registers.IY+ this->OpZ80(zx80_memory, this->registers.PC)));
          break;
    ...
    case PFX_CB:
      this->z80_exec_extended_FDCB(zx80_memory);break;
    default:{
      char str2[20];
      sprintf(str2,"unknown 0x%x",opcode);
      this->debug_opcode(str2, (char*)"");
