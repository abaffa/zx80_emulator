...
void Z80::z80_exec_extended_DDCB(struct zx80_memory* zx80_memory)
{
    unsigned char I; //register
    unsigned short J; //register

    J = this->registers.IX + this->OpZ80(zx80_memory, this->registers.PC);
    ...
    switch(I)
    {
        case RLC_xHL:      this->debug_opcode((char *)"RLC_xIX+BYTE", (char *)"The contents of the memory location pointed to by ix plus BYTE are rotated left one bit position. The content of bit 7 are copied to the carry flag and bit 0.");
            I = this->RdZ80(zx80_memory, J); M_RLC(this, I); WrZ80(zx80_memory, J, I); break; 
        ...
        case RRC_xHL:      this->debug_opcode((char *)"RRC_xIX+BYTE", (char *)"The contents of the memory location pointed to by ix plus BYTE are rotated right one bit position. The content of bit 0 are copied to the carry flag and bit 7.");
            I = this->RdZ80(zx80_memory, J); M_RRC(this, I); WrZ80(zx80_memory, J, I); break; 
        ...
        case RL_xHL:      this->debug_opcode((char *)"RL_xIX+BYTE", (char *)"The contents of the memory location pointed to by ix plus BYTE are rotated left one bit position. The content of bit 7 are copied to the carry flag and the previous contents of the carry flag are copied to bit 0.");
            I = this->RdZ80(zx80_memory, J); M_RL(this, I); WrZ80(zx80_memory, J, I); break; 
        ...
        case RR_xHL:      this->debug_opcode((char *)"RR_xIX+BYTE", (char *)"The contents of the memory location pointed to by ix plus BYTE are rotated right one bit position. The content of bit 0 are copied to the carry flag and the previous contents of the carry flag are copied to bit 7.");
            I = this->RdZ80(zx80_memory, J); M_RR(this, I); WrZ80(zx80_memory, J, I); break; 
        ...
        case SLA_xHL:      this->debug_opcode((char *)"SLA_xIX+BYTE", (char *)"The contents of the memory location pointed to by ix plus BYTE are shifted left one bit position. The content of bit 7 are copied to the carry flag and a zero is put into bit 0.");
            I = this->RdZ80(zx80_memory, J); M_SLA(this, I); WrZ80(zx80_memory, J, I); break; 
        ...
        case SRA_xHL:      this->debug_opcode((char *)"SRA_xIX+BYTE", (char *)"The contents of the memory location pointed to by ix plus BYTE are shifted right one bit position. The content of bit 0 are copied to the carry flag and the previous contents of bit 7 are unchanged.");
            I = this->RdZ80(zx80_memory, J); M_SRA(this, I); WrZ80(zx80_memory, J, I); break; 
        ...
        case SLL_xHL:      this->debug_opcode((char *)"SLL_xIX+BYTE", (char *)"The contents of the memory location pointed to by ix plus BYTE are shifted left one bit position. The content of bit 7 are put into the carry flag and a one is put into bit 0.");
            I = this->RdZ80(zx80_memory, J); M_SLL(this, I); WrZ80(zx80_memory, J, I); break; 
        ...
        default:{
            ...
            (
                ...
                (long)(this->User),this->OpZ80(zx80_memory, this->registers.PC-2),this->OpZ80(zx80_memory, this->registers.PC-1),this, this->registers.PC-4
            );
        }
    }
}
...
void Z80::z80_exec_extended_DD(struct zx80_memory* zx80_memory)
{
  unsigned char I; //register
  unsigned short J; //register
...
//  #define XX IX
  ...
  switch(I)
  {
    ...
    case ADD_xHL:       this->debug_opcode((char *)"ADD_xIX+BYTE", (char *)"Adds the value pointed by (IX) plus BYTE to A");
        I = this->RdZ80(zx80_memory, this->registers.IX + this->OpZ80(zx80_memory, this->registers.PC));
        M_ADD(this, I); break;
    ...
    case INC_xHL:       this->debug_opcode((char *)"INC_xIX+BYTE", (char *)"Adds one to the memory location pointed to by IX plus BYTE.");
        I = this->RdZ80(zx80_memory, this->registers.IX + this->RdZ80(zx80_memory, this->registers.PC));
        M_INC_L(this, I);
		this->WrZ80(zx80_memory,  this->registers.IX + this->OpZ80(zx80_memory, this->registers.PC), I);
        break;
    ...
    case POP_HL:       this->debug_opcode((char *)"POP_IX", (char *)"The memory location pointed to by SP is stored into IXl and SP is incremented. The memory location pointed to by SP is stored into IXh and SP is incremented again"); 
        M_POP(this, zx80_memory, IX);break;

    case EX_xSP_HL:      this->debug_opcode((char *)"EX_xSP_IX", (char*)"Exchanges (SP) with IXl, and (SP+1) with IXh");
        J = this->registers.IX;
        SET_WORD(this->registers.IX, RdZ80(zx80_memory, this->registers.SP), 
                                    RdZ80(zx80_memory, this->registers.SP + 1)); 
        
        WrZ80(zx80_memory,  this->registers.SP, LSB(J));
        WrZ80(zx80_memory,  this->registers.SP+1, MSB(J));
    ...
    case PUSH_HL:       this->debug_opcode((char *)"PUSH_IX", (char *)"SP is decremented and IXh is stored into the memory location pointed to by SP. SP is decremented again and IXl is stored pointed to by SP"); 
        M_PUSH(this, zx80_memory, IX);break;

                    
      case LD_HL_WORD:    this->debug_opcode_reg_word(zx80_memory, (char *)"LD_IX_WORD", (char *)"Loads ** into IX"); 
          M_LDWORD(this, zx80_memory, this->registers.IX);break;
      case LD_xWORD_HL:    this->debug_opcode_reg_word(zx80_memory, (char *)"LD_xWORD_IX", (char *)"Stores IX into the memory location pointed to by WORD");
        SET_LSB(J, this->OpZ80(zx80_memory, this->registers.PC));
        SET_MSB(J, this->OpZ80(zx80_memory, this->registers.PC));
        WrZ80(zx80_memory, J, LSB(this->registers.IX));
        J += 1;
        WrZ80(zx80_memory, J, MSB(this->registers.IX));
        break;
      case LD_H_BYTE:     this->debug_opcode_reg_byte(zx80_memory, (char *)"LD_IXh_BYTE", (char *)"Load BYTE into IXh");
          SET_MSB(this->registers.IX, this->OpZ80(zx80_memory, this->registers.PC));
          break;
      case LD_HL_xWORD:    this->debug_opcode_reg_word(zx80_memory, (char *)"LD_IX_xWORD", (char *)"Load value pointed to by WORD into IX");
        SET_LSB(J, this->OpZ80(zx80_memory, this->registers.PC));
        SET_MSB(J, this->OpZ80(zx80_memory, this->registers.PC));
        SET_LSB(this->registers.IX, RdZ80(zx80_memory, J));
        J += 1;
        SET_MSB(this->registers.IX, RdZ80(zx80_memory, J));
        break;
      case LD_L_BYTE:     this->debug_opcode_reg_byte(zx80_memory, (char *)"LD_IXl_BYTE", (char *)"Load BYTE into IXl");
          SET_LSB(this->registers.IX, this->OpZ80(zx80_memory, this->registers.PC));
          break;

      case LD_xHL_BYTE:   this->debug_opcode_reg_byte(zx80_memory, (char *)"LD_xIXl_BYTE", (char *)"Stores BYTE to the memory location pointed to by IX plus BYTE");
          J = this->registers.IX + this->OpZ80(zx80_memory, this->registers.PC);
          WrZ80(zx80_memory, J,this->OpZ80(zx80_memory, this->registers.PC));
          break;
      ...
      case LD_B_xHL:      this->debug_opcode((char *)"LD_B_xIX", (char *)"The contents of IX plus BYTE are loaded into B");
          SET_MSB(this->registers.BC, RdZ80(zx80_memory, this->registers.IX + this->OpZ80(zx80_memory, this->registers.PC)));
          break;
      ...
      case LD_C_xHL:      this->debug_opcode((char *)"LD_C_xIX", (char *)"The contents of IX plus BYTE are loaded into C");
          SET_LSB(this->registers.BC, RdZ80(zx80_memory, this->registers.IX + this->OpZ80(zx80_memory, this->registers.PC)));
          break;
      ...
      case LD_D_xHL:      this->debug_opcode((char *)"LD_D_xIX", (char *)"The contents of IX plus BYTE are loaded into D");
          SET_MSB(this->registers.DE, RdZ80(zx80_memory, this->registers.IX + this->OpZ80(zx80_memory, this->registers.PC)));
          break;
      ...
      case LD_E_xHL:      this->debug_opcode((char *)"LD_E_xIX", (char *)"The contents of IX plus BYTE are loaded into E");
          SET_LSB(this->registers.DE, RdZ80(zx80_memory, this->registers.IX + this->OpZ80(zx80_memory, this->registers.PC)));
          break;
      ...
      case LD_H_xHL:      this->debug_opcode((char *)"LD_H_IXL", (char *)"Loads the value pointed to IX plus BYTE into H");
          SET_MSB(this->registers.HL, RdZ80(zx80_memory, this->registers.IX + this->OpZ80(zx80_memory, this->registers.PC)));
          break;
      ...
      case LD_L_xHL:        this->debug_opcode((char *)"LD_L_xIX", (char *)"Loads the value pointed to IX plus BYTE into L");
          SET_LSB(this->registers.HL, RdZ80(zx80_memory, this->registers.IX + this->OpZ80(zx80_memory, this->registers.PC)));
          break;
      ...
      case LD_A_xHL:        this->debug_opcode((char *)"LD_L_xIX", (char *)"Loads the value pointed to IX plus BYTE into A");
          SET_MSB(this->registers.AF, RdZ80(zx80_memory, this->registers.IX+ this->OpZ80(zx80_memory, this->registers.PC)));
          break;
    ...
    case PFX_CB:
      this->z80_exec_extended_DDCB(zx80_memory);break;
    default:{
      char str2[20];
      sprintf(str2,"unknown 0x%x",opcode);
      this->debug_opcode(str2, (char*)"");
      ...
      (
          ...
          (long)this->User,this->OpZ80(zx80_memory, this->registers.PC-1),this->registers.PC-2
      );
    }
  //#undef XX
  }
