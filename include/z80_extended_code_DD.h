...
//  #define XX IX
  ...
  switch(I)
  {
    ...
    case PUSH_HL:       debug_opcode(z80, (char *)"PUSH_IX", (char *)"SP is decremented and IXh is stored into the memory location pointed to by SP. SP is decremented again and IXl is stored pointed to by SP"); 
      ...
      case LD_HL_WORD:    debug_opcode_reg_word(z80, (char *)"LD_IX_WORD", (char *)"Loads ** into IX"); 
          M_LDWORD(z80, z80->registers.IX);break;
      case LD_xWORD_HL:    debug_opcode_reg_word(z80, (char *)"LD_xWORD_IX", (char *)"Stores IX into the memory location pointed to by WORD");
        ...
        break;
      case LD_H_BYTE:     debug_opcode_reg_byte(z80, (char *)"LD_IXh_BYTE", (char *)"Load BYTE into IXh");
          SET_MSB(z80->registers.IX, OpZ80(z80, z80->registers.PC));
          break;
      case LD_HL_xWORD:    debug_opcode_reg_word(z80, (char *)"LD_IX_xWORD", (char *)"Load value pointed to by WORD into IX");
        SET_LSB(J, OpZ80(z80, z80->registers.PC));
        SET_MSB(J, OpZ80(z80, z80->registers.PC));
        ...
        break;
      case LD_L_BYTE:     debug_opcode_reg_byte(z80, (char *)"LD_IXl_BYTE", (char *)"Load BYTE into IXl");
          SET_LSB(z80->registers.IX, OpZ80(z80, z80->registers.PC));
          break;

      case LD_xHL_BYTE:   debug_opcode_reg_byte(z80, (char *)"LD_xIXl_BYTE", (char *)"Stores BYTE to the memory location pointed to by IX plus BYTE");
          J = z80->registers.IX + OpZ80(z80, z80->registers.PC);
