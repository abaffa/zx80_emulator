...
void debug_opcode_reg_word(struct z80* z80, char *op, char *desc){
    if(DEBUG_OPCODE == 1){
        ...
        //printf("opcode: %s_%02x\n", op, WORD(z80->memory.memory[z80->registers.PC], z80->memory.memory[z80->registers.PC+1]));
        //printf("%s\n\n", desc);
    }
}
...
void debug_opcode_reg_byte(struct z80* z80, char *op, char *desc){
    if(DEBUG_OPCODE == 1){
        ...
        //printf("opcode: %s_&01x\n", op, z80->memory.memory[z80->registers.PC]);
        //printf("%s\n\n", desc);
    }
}
...
void z80_exec(struct z80* z80)
{
    ...
    switch(opcode)
    {
        ...
        if(z80->ICount<=0 && 0) // para nunca entrar aqui
        {
